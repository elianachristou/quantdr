...
You can install the released version of quantdr from [CRAN](https://CRAN.R-project.org) with: (this will work when the package is released to CRAN - this parenthesis will be removed once the package is available in CRAN)
...
```{r, warning = FALSE, fig.height = 6, fig.width = 7, fig.align = "center"}
library(MASS)
attach(Boston)
# read the data 
y <- medv
