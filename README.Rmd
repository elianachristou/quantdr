...
The `quantdr` package includes internal code adapted from the `dr` package by [Cook, R. D., & Ni, L. (2005) Sufficient Dimension Reduction via Inverse Regression: A Minimum Discrepancy Approach. *Journal of the American Statistical Association*, 100(470), 410–428](https://www.tandfonline.com/doi/abs/10.1198/016214504000001501), which is no longer maintained on CRAN. 
