...
If $d_{\tau}$ is unknown, a suggested structural dimension can be estimated using the modified-BIC type criterion of Zhu et al. (2010).  For this we use the `bic_d` function of the presented package.  
