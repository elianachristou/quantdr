...
To get started you need to first install the package successfully using the command 
```{r, eval=FALSE}
...
To get help on a specific function you can type `help(function.name)` or `?function.name`.  Try
```{r, eval=FALSE}
help(cqs)
?cqs
```
